    ...
    public  class DCliente
    {
        ...
        public string Insertar(DCliente cliente)
        {
            ...
            try
            {
                ...
                cmm.Connection = cnn;
                cmm.CommandText = "spinsertar_cliente";
        ...
        public string Editar(DCliente cliente)
        {
            ...
            try
            {
                ...
                SqlCommand cmm = new SqlCommand();
                cmm.Connection = cnn;
                cmm.CommandText = "speditar_cliente";
                cmm.CommandType = CommandType.StoredProcedure;
        ...
        public string Eliminar(DCliente cliente)
        {
            ...
            try
            {
                ...
                SqlCommand cmm = new SqlCommand();
                cmm.Connection = cnn;
                cmm.CommandText = "speliminar_cliente";
                cmm.CommandType = CommandType.StoredProcedure;
        ...
        public  DataTable Mostrar()
        {
            ...
            try
            {
                ...
                SqlCommand cmm = new SqlCommand();
                cmm.Connection = cnn;
                cmm.CommandText = "spmostrar_cliente";
                cmm.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BuscarApellido(DCliente cliente)
        {
            ...
            try
            {
                ...
                SqlCommand cmm = new SqlCommand();
                cmm.Connection = cnn;
                cmm.CommandText = "spbuscar_cliente_apellidos";
                cmm.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BuscarDocumento(DCliente cliente)
        {
            ...
            try
            {
                ...
                SqlCommand cmm = new SqlCommand();
                cmm.Connection = cnn;
                cmm.CommandText = "spbuscar_cliente_num_documento";
                cmm.CommandType = CommandType.StoredProcedure;
